...
| [`memory/`](memory/README.md) | Cross-session curated knowledge: memory seam, markdown provider with SQLite hybrid recall, and memory tools/injection | Product — new capability (in development) |
