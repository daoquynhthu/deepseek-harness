...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  MemoryChunk: 'memory.md',
  MemoryFile: 'memory.md',
  MemoryInjectRequest: 'memory.md',
  MemoryPath: 'memory.md',
  MemoryRetrievalMode: 'memory.md',
  MemoryScope: 'memory.md',
  MemorySearchConfig: 'memory.md',
  MemorySearchPage: 'memory.md',
  MemorySearchRequest: 'memory.md',
  MemorySearchResult: 'memory.md',
  TemporalDecayConfig: 'memory.md',
